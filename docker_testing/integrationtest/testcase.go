...
func testLeakedPasswordScanner(prefix, file string) {
	...
	if strings.Contains(out, `statement: CREATE USER user0 WITH PASSWORD 'password'; => Password : password
statement: CREATE USER user1 WITH PASSWORD 'password'; => Password : password
statement: CREATE USER user2 WITH PASSWORD 'password'; => Password : password
statement: CREATE USER user3 WITH PASSWORD 'password'; => Password : password
statement: CREATE USER user4 WITH PASSWORD 'password'; => Password : password
statement: CREATE USER user5 WITH PASSWORD 'password'; => Password : password`) {
		fmt.Println("unused lines test is working fine for prefix:", prefix)
		return
	}
